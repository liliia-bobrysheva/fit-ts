...
export function getMessageName(messageNum) {
    ...
    return message === null || message === void 0 ? void 0 : message.name; // TODO rewrite to get rid of "?"
}
export function getFieldObject(fieldNum, messageNum) {
    const message = FIT.messages[messageNum];
    return message === null || message === void 0 ? void 0 : message[fieldNum]; // TODO handle null mesage
}
