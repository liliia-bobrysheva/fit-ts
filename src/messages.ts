...
export type WorkoutCapabilities =
  | 0
  | "interval"
  | "custom"
  | "fitness_equipment"
...
export type SegmentLeaderboardType =
  | "overall"
  | "personal_best"
  | "connections"
  | "group"
...
export type SensorType =
  ...
  | "compass"
  | "barometer";
export type BikeLightNetworkConfigType =
  | "auto"
  | "individual"
  | "high_visibility"
  | "trail";
export type CommTimeoutType =
  | "wildcard_pairing_timeout"
  | "pairing_timeout"
  | "connection_lost"
  | "connection_timeout";
export type CameraOrientationType =
...
export type AttitudeValidity =
  ...
  | "true_track_angle"
  | "magnetic_heading";
export type AutoSyncFrequency =
  | "never"
  | "occasionally"
  | "frequent"
  | "once_a_day"
  | "remote";
export type ExdLayout =
  | "full_screen"
  | "half_vertical"
  | "half_horizontal"
...
export type ExdDescriptors =
  ...
  | "pressure"
  | "vam";
export type AutoActivityDetect =
  | "none"
  | "running"
  | "cycling"
  | "swimming"
...
export type ExerciseCategory =
  ...
  | "run"
  | "unknown";
export type BenchPressExerciseName =
...
export type CalfRaiseExerciseName =
  | "3_way_calf_raise"
...
export type CarryExerciseName =
  | "bar_holds"
  | "farmers_walk"
  | "farmers_walk_on_toes"
  | "hex_dumbbell_hold"
  | "overhead_carry";
export type ChopExerciseName =
  | "cable_pull_through"
...
export type CoreExerciseName =
  ...
  | "teaser"
  | "the_hundred";
export type CrunchExerciseName =
  | "bicycle_crunch"
  | "cable_crunch"
  | "circular_arm_crunch"
  | "crossed_arms_crunch"
...
export type FlyeExerciseName =
  ...
  | "arm_rotations"
  | "hug_a_tree";
export type HipRaiseExerciseName =
...
export type HipStability_ExerciseName =
...
export type HipSwingExcerciseName =
  | "single_arm_kettlebell_swing"
  | "single_arm_dumbbell_swing"
  | "step_out_swing";
export type HyperextensionExercise_name =
  ...
  | "cobra"
  | "supine_floor_barre";
export type LateralRaiseExerciseName =
  ...
  | "arm_circles"
  | "shaving_the_head";
export type LegCurlExerciseName =
  | "leg_curl"
  | "weighted_leg_curl"
  | "good_morning"
...
export type LegRaiseExerciseName =
  | "hanging_knee_raise"
  | "hanging_leg_raise"
...
export type OlympicLiftExercise_name =
...
export type PullUpExerciseName =
  | "banded_pull_ups"
  ...
  | "pull_up";
export type PushUpExerciseName =
...
export type ShoulderPressExerciseName =
...
export type ShoulderStabilityExerciseName =
...
export type TotalBodyExerciseName =
  | "burpee"
  | "weighted_burpee"
  | "burpee_box_jump"
...
export type TricepsExtensionExerciseName =
  | "bench_dip"
  | "weighted_bench_dip"
  | "body_weight_dip"
  | "cable_kickback"
...
export interface Types {
  ...
  mesg_num: { [key: number]: MesgNum };
  checksum: { [key: number]: Checksum };
  file_flags: { [key: number]: FileFlags };
  mesg_count: { [key: number]: MesgCount };
  date_time: { [key: number]: DateTime };
  local_date_time: { [key: number]: LocalDateTime };
  message_index: { [key: number]: MessageIndex };
  gender: { [key: number]: Gender };
  language: { [key: number]: Language };
  language_bits_0: { [key: number]: LanguageBits0 };
  ...
  sport_bits_3: { [key: number]: SportBits3 };
  sport_bits_4: { [key: number]: SportBits4 };
  sport_bits_5: { [key: number]: SportBits5 };
  sport_bits_6: { [key: number]: SportBits6 };
  sub_sport: { [key: number]: SubSport };
  sport_event: { [key: number]: SportEvent };
  activity: { [key: number]: Activity };
  intensity: { [key: number]: Intensity };
  session_trigger: { [key: number]: SessionTrigger };
  autolap_trigger: { [key: number]: AutolapTrigger };
  lap_trigger: { [key: number]: LapTrigger };
  time_mode: { [key: number]: TimeMode };
  ...
  wkt_step_duration: { [key: number]: WktStepDuration };
  wkt_step_target: { [key: number]: WktStepTarget };
  goal: { [key: number]: Goal };
  ...
  ant_network: { [key: number]: ANTNetwork };
  workout_capabilities: { [key: number]: WorkoutCapabilities };
  battery_status: { [key: number]: BatteryStatus };
  hr_type: { [key: number]: HRType };
  course_capabilities: { [key: number]: CourseCapabilities };
  weight: { [key: number]: Weight };
  workout_hr: { [key: number]: WorkoutHR };
  workout_power: { [key: number]: WorkoutPower };
  bp_status: { [key: number]: BPStatus };
  user_local_id: { [key: number]: UserLocalId };
  swim_stroke: { [key: number]: SwimStroke };
  activity_type: { [key: number]: ActivityType };
  activity_subtype: { [key: number]: ActivitySubtype };
  activity_level: { [key: number]: ActivityLevel };
  side: { [key: number]: Side };
  left_right_balance: { [key: number]: LeftRightBalance };
  left_right_balance_100: { [key: number]: LeftRightBalance100 };
  length_type: { [key: number]: LengthType };
  day_of_week: { [key: number]: DayOfWeek };
  connectivity_capabilities: { [key: number]: ConnectivityCapabilities };
  weather_report: { [key: number]: WeatherReport };
  weather_status: { [key: number]: WeatherStatus };
  weather_severity: { [key: number]: WeatherSeverity };
  weather_severe_type: { [key: number]: WeatherSevereType };
  stroke_type: { [key: number]: StrokeType };
  body_location: { [key: number]: BodyLocation };
  segment_lap_status: { [key: number]: SegmentLapStatus };
  segment_leaderboard_type: { [key: number]: SegmentLeaderboardType };
  segment_delete_status: { [key: number]: SegmentDeleteStatus };
  segment_selection_type: { [key: number]: SegmentSelectionType };
  source_type: { [key: number]: SourceType };
  display_orientation: { [key: number]: DisplayOrientation };
  workout_equipment: { [key: number]: WorkoutEquipment };
  watchface_mode: { [key: number]: WatchfaceMode };
  digital_watchface_layout: { [key: number]: DigitalWatchfaceLayout };
  analog_watchface_layout: { [key: number]: AnalogWatchfaceLayout };
  rider_position_type: { [key: number]: RiderPositionType };
  power_phase_type: { [key: number]: PowerPhaseType };
  camera_event_type: { [key: number]: CameraEventType };
  sensor_type: { [key: number]: SensorType };
  bike_light_network_config_type: { [key: number]: BikeLightNetworkConfigType };
  comm_timeout_type: { [key: number]: CommTimeoutType };
  camera_orientation_type: { [key: number]: CameraOrientationType };
  attitude_stage: { [key: number]: AttitudeStage };
  attitude_validity: { [key: number]: AttitudeValidity };
  auto_sync_frequency: { [key: number]: AutoSyncFrequency };
  exd_layout: { [key: number]: ExdLayout };
  exd_display_type: { [key: number]: ExdDisplayType };
  exd_data_units: { [key: number]: ExdDataUnits };
  exd_qualifiers: { [key: number]: ExdQualifiers };
  exd_descriptors: { [key: number]: ExdDescriptors };
  auto_activity_detect: { [key: number]: AutoActivityDetect };
  supported_exd_screen_layouts: { [key: number]: SupportedExdScreenLayouts };
  ...
  calf_raise_exercise_name: { [key: number]: CalfRaiseExerciseName };
  cardio_exercise_name: { [key: number]: CardioExerciseName };
  carry_exercise_name: { [key: number]: CarryExerciseName };
  chop_exercise_name: { [key: number]: ChopExerciseName };
  core_exercise_name: { [key: number]: CoreExerciseName };
  crunch_exercise_name: { [key: number]: CrunchExerciseName };
  curl_exercise_name: { [key: number]: CurlExerciseName };
  deadlift_exercise_name: { [key: number]: DeadliftExerciseName };
  flye_exercise_name: { [key: number]: FlyeExerciseName };
  hip_raise_exercise_name: { [key: number]: HipRaiseExerciseName };
  hip_stability_exercise_name: { [key: number]: HipStability_ExerciseName };
  hip_swing_excercise_name: { [key: number]: HipSwingExcerciseName };
  hyperextension_exercise_name: { [key: number]: HyperextensionExercise_name };
  lateral_raise_exercise_name: { [key: number]: LateralRaiseExerciseName };
  leg_curl_exercise_name: { [key: number]: LegCurlExerciseName };
  leg_raise_exercise_name: { [key: number]: LegRaiseExerciseName };
  lunge_exercise_name: { [key: number]: LungeExerciseName };
  olympic_lift_exercise_name: { [key: number]: OlympicLiftExercise_name };
  plank_exercise_name: { [key: number]: PlankExerciseName };
  plyo_exercise_name: { [key: number]: PlyoExerciseName };
  pull_up_exercise_name: { [key: number]: PullUpExerciseName };
  push_up_exercise_name: { [key: number]: PushUpExerciseName };
  row_exercise_name: { [key: number]: RowExerciseName };
  shoulder_press_exercise_name: { [key: number]: ShoulderPressExerciseName };
  shoulder_stability_exercise_name: {
    [key: number]: ShoulderStabilityExerciseName;
  };
  shrug_exercise_name: { [key: number]: ShrugExerciseName };
  sit_up_exercise_name: { [key: number]: SitUpExerciseName };
  squat_exercise_name: { [key: number]: SquatExerciseName };
  total_body_exercise_name: { [key: number]: TotalBodyExerciseName };
  triceps_extension_exercise_name: {
    [key: number]: TricepsExtensionExerciseName;
  };
  warm_up_exercise_name: { [key: number]: WarmUpxerciseName };
  run_exercise_name: { [key: number]: RunExerciseName };
  water_type: { [key: number]: WaterType };
  tissue_model_type: { [key: number]: TissueModelType };
  dive_gas_status: { [key: number]: DiveGasStatus };
